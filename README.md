...
A production-ready, conversion-optimized marketplace for hiring local trade workers (maestros) in Mexico. This refactored version implements all P0–P2 UX audit recommendations plus a full photo u[...]
...
New worker registrations are created with `verificationStatus: "pending"` and do not appear in the public catalog, search, or profile pages until an administrator approves them. The admin dashboa[...]